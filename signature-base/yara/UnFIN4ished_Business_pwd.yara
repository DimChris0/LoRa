rule UnFIN4ished_Business_pwd
{
	strings:
		...
		$Filename2 = "WINWORD32.exe"
		$Filename3 = "rpt-fin4.pdf"
		$Host1 = "www.advantarlabs.com"
		$URL4 = "https://www.esentire.com/wp-content/uploads/2013/11/esentire_alert_20131108_DOCM.pdf"
		$Filename4 = "esentire_alert_20131108_DOCM.pdf"
		$Host2 = "www.esentire.com"
	condition:
		$MD51 or $Filename1 or $URL1 or $URL2 or $URL3 or $Filename2 or $Filename3 or $Host1 or $URL4 or $Filename4 or $Host2
}