rule ANALYSIS_ON_APT_TO_BE_ATTACK_THAT_FOCUSING_ON_CHINAS_GOVERNMENT_AGENCY_
{
	strings:
		...
		$Filename2 = "powershell.exe"
		$Filename3 = "ab.exe"
		$MD51 = "44BCF2DD262F12222ADEAB6F59B2975B"
		$Filename4 = "powershell.exe"
		$Filename5 = "powershell.exe"
		$Filename6 = "powershell.exe"
		...
		$Host8 = "www.antiy.net"
	condition:
		$Filename1 or $Filename2 or $Filename3 or $MD51 or $Filename4 or $Filename5 or $Filename6 or $URL1 or $IP1 or $Filename7 or $Filename8 or $Host1 or $Host2 or $URL2 or $URL3 or $URL4 or $URL5 or $URL6 or $URL7 or $URL8 or $Filename9 or $Filename10 or $Host3 or $Host4 or $Host5 or $URL9 or $Host6 or $Host7 or $Host8
}