rule Palebot_Palestinian_credentials
{
	strings:
		...
		$Host3 = "portal.iugaza.edu.ps"
		$Host4 = "myaccount.jawwal.ps"
		$Host5 = "www.myspace.com"
		$Host6 = "moneybookers.com"
		$Host7 = "mail.mtit.pna.ps"
		$Host8 = "www.alsbah.net"
		$MD51 = "7f3b74c9274f501bf0d9ded414b62f80"
		$MD52 = "25f758425fcea95ea07488e13f07e005"
		$MD53 = "1954622c1fe142200ad06eec12291fcd"
	condition:
		$URL1 or $URL2 or $Filename1 or $Filename2 or $Host1 or $URL3 or $URL4 or $URL5 or $URL6 or $URL7 or $URL8 or $URL9 or $URL10 or $URL11 or $Filename3 or $Host2 or $Host3 or $Host4 or $Host5 or $Host6 or $Host7 or $Host8 or $MD51 or $MD52 or $MD53
}