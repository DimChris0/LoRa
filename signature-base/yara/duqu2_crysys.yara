rule duqu2_crysys
{
	...
	condition:
		$MD51 or $MD52 or $IP1 or $IP2 or $IP3 or $IP4 or $IP5 or $IP6 or $IP7 or $IP8 or $IP9 or $Host1 or $URL1 or $URL2 or $Filename1 or $Filename2 or $Filename3 or $Email1 or $Email2
}