rule Miniduke_twitter
{
	...
	condition:
		$CVE1 or $Filename1 or $Filename2 or $Filepath1 or $Filepath2 or $Host1 or $URL1 or $Host2 or $Filename3 or $SHA11 or $SHA12 or $SHA13 or $SHA14 or $SHA15 or $URL2
}