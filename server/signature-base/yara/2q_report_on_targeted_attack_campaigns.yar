...
}rule q_report_on_targeted_attack_campaigns
{
	strings:
		$Filename1 = "explorer.exe"
		$Filename2 = "fxsst.dll"
		...
		$CVE2 = "CVE-2012-2543"
		$CVE3 = "CVE-2013-0640"
		$Filename3 = "Live360.exe"
		$Filename4 = "IEChecker.exe"
		$Filename5 = "Iexplorer.exe"
		$Filename6 = "svchost.dll"
		$Filename7 = "svchost.exe"
		$Filename8 = "winlogon.exe"
		$Filename9 = "avp.exe"
		$Filename10 = "klwtblfs.exe"
		$Filename11 = "starter.exe"
		$Filename12 = "wmifw.exe"
		$Registry1 = "HKCU\\Software\\rar"
		$Registry2 = "HKLM\\SOFTWARE\\rar"
		$Filename13 = "pstorec.dll"
		$Filename14 = "kav.exe"
		$Registry3 = "HKCU\\Software\\Microsoft\\Windows"
		$Registry4 = "HKCU\\Software\\Microsoft\\Internet"
		$Registry5 = "HKCU\\Software\\Microsoft\\Office\\Outlook"
		$IP1 = "112.121.182.150"
		$IP2 = "113.10.246.46"
		$IP3 = "113.10.190.55"
		$IP4 = "202.130.112.231"
		...
		$Host2 = "qtds1979.gicp.net"
		$IP5 = "111.222.123.132"
		$Filename15 = "wp_ixeshe.pdf"
		$Filename16 = "wp_the_taidoor_campaign.pdf"
	condition:
		$Filename1 or $Filename2 or $CVE1 or $CVE2 or $CVE3 or $Filename3 or $Filename4 or $Filename5 or $Filename6 or $Filename7 or $Filename8 or $Filename9 or $Filename10 or $Filename11 or $Filename12 or $Registry1 or $Registry2 or $Filename13 or $Filename14 or $Registry3 or $Registry4 or $Registry5 or $IP1 or $IP2 or $IP3 or $IP4 or $Host1 or $Host2 or $IP5 or $Filename15 or $Filename16
}rule q_report_on_targeted_attack_campaigns
{
	strings:
		$Filename1 = "explorer.exe"
