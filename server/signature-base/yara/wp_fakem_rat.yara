rule wp_fakem_rat
{
	strings:
		...
		$Filename7 = "tpframe.exe"
		$Host2 = "upx.sourceforge.net"
		$Host3 = "www.mysonicwall.com"
		$Host4 = "vcvcvcvc.dyndns.org"
		$Host5 = "zjhao.dtdns.net"
		$Host6 = "avira.suroot.com"
		$Host7 = "vcvcvcvc.dyndns.org"
		$Host8 = "avira.suroot.com"
		$Host9 = "apple12.crabdance.com"
		$Host10 = "apple12.co.cc"
		$Host11 = "yourturbe.org"
		$Host12 = "endless.zapto.org"
		$Host13 = "sytes.net"
	condition:
		$URL1 or $Filename1 or $Filename2 or $Filename3 or $Filename4 or $Host1 or $CVE1 or $CVE2 or $CVE3 or $URL2 or $URL3 or $URL4 or $URL5 or $Filename5 or $Filename6 or $Filename7 or $Host2 or $Host3 or $Host4 or $Host5 or $Host6 or $Host7 or $Host8 or $Host9 or $Host10 or $Host11 or $Host12 or $Host13
}