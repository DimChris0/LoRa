rule GData_Uroburos_RedPaper_EN_v1
{
	...
	condition:
		$URL1 or $Filename1 or $Filename2 or $Host1 or $Filename3 or $Filename4 or $Filename5 or $Registry1 or $Filename6 or $Filename7 or $Host2 or $Host3 or $URL2 or $SHA2561 or $MD51
}