rule fireeye_sidewinder_targeted_attack
{
	strings:
		...
		$Host7 = "android.googlesource.com"
		...
		$Host9 = "isc.sans.edu"
		$Host10 = "www.networkworld.com"
	condition:
		$URL1 or $Filename1 or $URL2 or $URL3 or $Filename2 or $Filename3 or $Filename4 or $URL4 or $URL5 or $URL6 or $Filename5 or $Host1 or $Host2 or $Host3 or $URL7 or $URL8 or $Filename6 or $URL9 or $URL10 or $URL11 or $URL12 or $URL13 or $Filename7 or $Host4 or $Host5 or $Host6 or $Host7 or $URL14 or $Filename8 or $Filename9 or $URL15 or $Filename10 or $Host8 or $CVE1 or $URL16 or $URL17 or $Filename11 or $Host9 or $Host10
}