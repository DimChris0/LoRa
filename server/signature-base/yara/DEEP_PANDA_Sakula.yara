rule DEEP_PANDA_Sakula
{
	strings:
		...
		$Host5 = "foundationssl.com"
		$Filename3 = "index.html"
	condition:
		$IP1 or $Filename1 or $Filename2 or $MD51 or $MD52 or $MD53 or $Host1 or $Email1 or $IP2 or $Host2 or $Host3 or $Host4 or $Host5 or $Filename3
}