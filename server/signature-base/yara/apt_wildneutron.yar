...
meta:
	...
	strings:
		$s0 = "LiveUpdater.exe" fullword wide  /* score: '25.00' */
		$s1 = "id-at-postalAddress" fullword ascii  /* score: '18.00' */
		$s2 = "%d -> %d (default)" fullword wide  /* score: '17.00' */
		$s3 = "%s%s%s=%d,%s=%d,%s=%d," fullword wide 
		$s8 = "id-ce-keyUsage" fullword ascii /* score: '12.00' */
		$s9 = "Key Usage" fullword ascii /* score: '12.00' */
		$s32 = "UPDATE_ID" fullword wide  /* score: '9.00' */
...
meta:
	...
	strings:
		$s0 = "rundll32.exe \"%s\",#1" fullword wide  /* score: '33.00' */
		$s1 = "IgfxUpt.exe" fullword wide /* score: '20.00' */
		$s2 = "id-at-postalAddress" fullword ascii  /* score: '18.00' */
		$s3 = "Intel(R) Common User Interface" fullword wide  /* score: '17.00' */
		$s4 = "%s%s%s=%d,%s=%d,%s=%d," fullword wide 
		$s11 = "Key Usage" fullword ascii /* score: '12.00' */
		$s12 = "Intel Integrated Graphics Updater" fullword wide  /* score: '12.00' */
...
meta:
	...
	strings:
		...
		$x2 = "\"http://fw.ddosprotected.eu:80 /opts resolv=drfx.chickenkiller.com\"" fullword wide  /* score: '33.00' */

		$s1 = "LiveUpdater.exe" fullword wide  /* score: '25.00' */
		$s2 = "id-at-postalAddress" fullword ascii  /* score: '18.00' */
		$s3 = "%d -> %d (default)" fullword wide  /* score: '17.00' */
		$s4 = "%s%s%s=%d,%s=%d,%s=%d," fullword wide 
		$s5 = "id-at-serialNumber" fullword ascii  /* score: '10.00' */
		$s6 = "ECDSA with SHA256" fullword ascii  /* score: '10.00' */
		$s7 = "Acer LiveUpdater" fullword wide  /* score: '10.00' */
	condition:
...
meta:
	...
	strings:
		...
		$s3 = "Driver Update and remove for Windows x64 or x86_32" fullword wide  /* score: '17.00' */
		...
		$s7 = "id-at-serialNumber" fullword ascii  /* score: '10.00' */
	condition:
...
meta:
	...
	strings:
		$s0 = "checking match for '%s' user %s host %s addr %s" fullword ascii  /* score: '24.00' */
		$s1 = "PEM_read_bio_PrivateKey failed" fullword ascii  /* score: '23.00' */
		$s2 = "usage: %s [-ehR] [-f log_facility] [-l log_level] [-u umask]" fullword ascii /* score: '23.00' */
		$s3 = "%s %s for %s%.100s from %.200s port %d%s" fullword ascii  /* score: '23.00' */
		$s4 = "clapi32.dll" fullword ascii /* score: '21.00' */
		$s5 = "Connection from %s port %d" fullword ascii  /* score: '17.00' */
...
meta:
	...
	strings:
		...
		$x5 = "Invalid input handle!!!" fullword ascii  /* score: '10.00' */

		$s1 = "Process %d terminated" fullword wide  /* score: '24.00' */
		...
		$s12 = "DEBUG: Cannot allocate memory for ptrNextNode->ptrNext!" fullword ascii  /* score: '10.00' */
		$s13 = "Failed to build full directory path" fullword wide /* score: '10.00' */
		$s14 = "DEBUG: Cannot allocate memory for ptrFileArray!" fullword ascii  /* score: '9.00' */
...
meta:
	...
	strings:
		$s0 = "http://get.adobe.com/flashplayer/" fullword wide  /* score: '30.00' */
		$s1 = "xxxxxxxxxxxxxxxxxxxx" fullword wide /* reversed goodware string 'xxxxxxxxxxxxxxxxxxxx' */ 
...
meta:
	...
	strings:
		$n1 = "/c for /L %%i in (1,1,2) DO ping 127.0.0.1 -n 3 & type %%windir%%\\notepad.exe > %s & del /f %s" fullword ascii  /* score: '46.00' */

		$s1 = "%SYSTEMROOT%\\temp\\_dbg.tmp" fullword ascii  /* score: '37.00' */
		$s2 = "%SYSTEMROOT%\\SysWOW64\\mspool.dll" fullword ascii  /* score: '36.17' */
		$s3 = "%SYSTEMROOT%\\System32\\dpcore16t.dll" fullword ascii  /* score: '36.17' */
		$s4 = "%SYSTEMROOT%\\System32\\wdigestEx.dll" fullword ascii  /* score: '36.17' */
		$s5 = "%SYSTEMROOT%\\System32\\mspool.dll" fullword ascii  /* score: '36.17' */
		$s6 = "%SYSTEMROOT%\\System32\\kernel32.dll" fullword ascii  /* score: '36.00' */
		$s7 = "%SYSTEMROOT%\\SysWOW64\\iastor32.exe" fullword ascii  /* score: '31.17' */
		$s8 = "%SYSTEMROOT%\\System32\\msvcse.exe" fullword ascii  /* score: '31.17' */
		$s9 = "%SYSTEMROOT%\\System32\\mshtaex.exe" fullword ascii  /* score: '31.17' */
		$s10 = "%SYSTEMROOT%\\System32\\iastor32.exe" fullword ascii  /* score: '31.17' */
		$s11 = "%SYSTEMROOT%\\SysWOW64\\mshtaex.exe" fullword ascii  /* score: '31.17' */

		$x1 = "wdigestEx.dll" fullword ascii  /* score: '26.00' */
		...
		$y1 = "Installer.exe" fullword ascii  /* score: '25.00' */
		$y2 = "Info: Process %s" fullword ascii  /* score: '21.00' */
		$y3 = "Error: GetFileTime %s 0x%x" fullword ascii /* score: '17.00' */
		$y4 = "Install succeeded" fullword ascii  /* score: '10.00' */
...
meta:
	...
	strings:
		...
		$s2 = "http://www.java.com/en/download/installed.jsp?detect=jre" fullword ascii  /* score: '28.00' */
