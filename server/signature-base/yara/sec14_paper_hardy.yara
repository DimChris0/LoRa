rule sec14_paper_hardy
{
	strings:
		...
		$Host5 = "tibetancareers.org"
		$Email3 = "palden.sangpo@tibetancareers.org"
		$Email4 = "chengli.brookings@aol.com"
		$Email5 = "palden.sangpo@tibetancareers.org"
		$Email6 = "albano_kuqo@gmx.com"
		$Email7 = "chengli.brookings@aol.com"
	condition:
		$URL1 or $URL2 or $Host1 or $URL3 or $URL4 or $Filename1 or $Filename2 or $Host2 or $Email1 or $Email2 or $Filename3 or $Host3 or $Host4 or $Host5 or $Email3 or $Email4 or $Email5 or $Email6 or $Email7
}