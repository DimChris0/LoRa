rule PEST_CONTROL
{
	...
	condition:
		$Host1 or $Host2 or $Email1 or $Email2 or $IP1 or $IP2 or $Filepath1 or $Filepath2 or $Filepath3 or $IP3 or $IP4 or $Host3 or $Host4 or $MD51 or $MD52 or $IP5 or $MD53
}