rule HTran_and_the_Advanced_Persistent_Threat
{
	strings:
		...
		$IP11 = "112.65.87.58"
		$IP12 = "58.247.25.108"
		$IP13 = "123.120.102.251"
		$IP14 = "123.120.106.136"
		$IP15 = "123.120.117.98"
		$IP16 = "123.120.126.73"
		$IP17 = "123.120.127.146"
		$IP18 = "58.247.240.91"
		$IP19 = "223.167.5.10"
		$IP20 = "223.167.5.250"
		$IP21 = "223.167.5.254"
		$IP22 = "112.64.214.174"
		$IP23 = "125.215.189.114"
		$IP24 = "121.229.201.158"
		$IP25 = "121.229.201.238"
		$IP26 = "112.64.213.249"
		...
		$MD518 = "7cb055ac3acbf53e07e20b65ec9126a1"
		$MD519 = "47a76cf2e60960405a492bc7f41b0483"
	condition:
		$URL1 or $IP1 or $Filename1 or $Host1 or $Host2 or $MD51 or $IP2 or $IP3 or $IP4 or $IP5 or $IP6 or $IP7 or $IP8 or $IP9 or $IP10 or $IP11 or $IP12 or $IP13 or $IP14 or $IP15 or $IP16 or $IP17 or $IP18 or $IP19 or $IP20 or $IP21 or $IP22 or $IP23 or $IP24 or $IP25 or $IP26 or $Host3 or $Host4 or $Host5 or $Host6 or $Host7 or $Host8 or $Host9 or $Host10 or $Host11 or $Host12 or $Host13 or $Host14 or $Host15 or $Host16 or $Host17 or $Host18 or $Host19 or $Host20 or $Host21 or $Host22 or $Host23 or $Host24 or $Host25 or $Host26 or $Host27 or $Host28 or $Host29 or $Host30 or $Host31 or $Host32 or $Host33 or $Host34 or $Host35 or $Host36 or $Host37 or $Host38 or $Host39 or $Host40 or $Host41 or $Host42 or $Host43 or $Host44 or $Host45 or $Host46 or $Host47 or $Host48 or $Host49 or $Host50 or $Host51 or $Host52 or $Host53 or $Host54 or $Host55 or $Host56 or $Host57 or $Host58 or $Host59 or $Host60 or $Host61 or $Host62 or $Host63 or $Host64 or $Host65 or $MD52 or $MD53 or $MD54 or $MD55 or $MD56 or $MD57 or $MD58 or $MD59 or $MD510 or $MD511 or $MD512 or $MD513 or $MD514 or $MD515 or $MD516 or $MD517 or $IP27 or $IP28 or $IP29 or $Host66 or $Host67 or $Host68 or $Host69 or $Host70 or $Host71 or $Host72 or $Host73 or $Host74 or $Host75 or $Host76 or $Host77 or $Host78 or $Host79 or $Host80 or $Host81 or $Host82 or $Host83 or $Host84 or $Host85 or $Host86 or $Host87 or $MD518 or $MD519
}