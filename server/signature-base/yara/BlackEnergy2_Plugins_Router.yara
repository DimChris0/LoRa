rule BlackEnergy2_Plugins_Router
{
	strings:
		...
		$IP26 = "94.185.85.122"
		$Filename3 = "ccprojectmgr.exe"
		$Filename4 = "main.dll"
		$MD51 = "f3395cd54cf857ddf8f2056768ff49ae"
		$MD52 = "bf0dac805798cc1f633f19ce8ed6382f"
		$Filename5 = "AliIde.sys"
		$Filename6 = "flashplayerapp.exe"
