rule NYTimes_Attackers_Evolve_Quickly
{
	strings:
		...
		$MD52 = "cb3dcde34fd9ff0e19381d99b02f9692"
		$MD53 = "aa873ed803ca800ce92a39d9a683c644"
	...
	condition:
		$Filename1 or $Host1 or $MD51 or $MD52 or $MD53 or $URL1 or $Filename2 or $Filename3
}